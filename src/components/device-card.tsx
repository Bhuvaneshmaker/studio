...
import { Wrench, ShieldAlert, CheckCircle2, ArrowRight, Server } from "lucide-react";
import { cn } from '@/lib/utils';

export function DeviceCard({ deviceId, elevators }: { deviceId: string, elevators: ElevatorData[] }) {
  ...
  return (
    <Card className={cn(
      ...
      <CardHeader className="p-4">
        ...
        <CardDescription>{elevators.length} Elevators / Slaves</CardDescription>
      </CardHeader>
